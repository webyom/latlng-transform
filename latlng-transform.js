(function () {
   ...
   */
  var transformFromWGSToGCJ = (function () {
    // const PI
  ...
  function wgs2gcj(lat, lng) {
    var p = latLng(lat, lng);
    return latLng(transformFromWGSToGCJ(p.lng, p.lat));
  }
  ...
  function gcj2wgs(lat, lng) {
    ...
    var mLat = p.lat - dLat, mLng = p.lng - dLng;
    var pLat = p.lat + dLat, pLng = p.lng + dLng;
    var wgsLat, wgsLng, i, tmp;
    for (i = 0; i < maxIteration; i++) {
      wgsLat = (mLat + pLat) / 2;
      wgsLng = (mLng + pLng) / 2;
      tmp = wgs2gcj(wgsLat, wgsLng);
      dLat = tmp.lat - p.lat;
      dLng = tmp.lng - p.lng;
  ...
  if (typeof module !== 'undefined' && module.exports) {
    module.exports = latlngTransform;
  } else if (typeof define === 'function' && typeof define.amd === 'object' && define.amd) {
    define(function () {
      return latlngTransform;
    });
  } else {
    window.latlngTransform = latlngTransform;
  }
})();
